...
public class AlfanumericActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_alfanumeric);
	   ...
	   buttonCancel.setOnClickListener(new View.OnClickListener() {
		...
		buttonContinue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
            	...
            	if (psw1.length() < 5)
            	{
            		textError.setText("M’nimo 5 caracteres");
            	}
            	...
            	else if (psw1.length() > 4 && psw2.length() > 1)
            	{
				      ...
				      if (!psw1.equals(psw2)) 				         
				    	  textError.setText("Las contrase–as no coinciden");
				      else
				      {
				    	  Intent i = new Intent();
            	...
            	else 
            	{
            		...
            		textTittle.setText("Confirmar contrase–a:");
